        ...
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            Aircraft[] aircrafts = new Aircraft[]
            {
                new Aircraft{Id = Guid.NewGuid(), Registration = "OO-SNJ", AircraftTypeId = aircraftTypes[0].Id, AirlineId = airlines[0].Id,
                    HasSpecialLivery = false, FirstSeen = new DateTime(2021, 07, 08), LastSeen = new DateTime(2021, 07, 08), Image = "images/IMG_2232.jpg",
                    AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
                new Aircraft{Id = Guid.NewGuid(), Registration = "OO-LOE", AircraftTypeId = aircraftTypes[1].Id, AirlineId = airlines[1].Id,
                    HasSpecialLivery = false, FirstSeen = new DateTime(2020, 07, 13), LastSeen = new DateTime(2021, 07, 08), Image = "images/95656_1575311187.jpg",
                    AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
                new Aircraft{Id = Guid.NewGuid(), Registration = "D-ALCC", AircraftTypeId = aircraftTypes[2].Id, AirlineId = airlines[2].Id,
                    HasSpecialLivery = false, FirstSeen = new DateTime(2020, 07, 29), LastSeen = new DateTime(2021, 07, 25) , Image = "images/1179688.jpg",
                    AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
                new Aircraft{ Id = Guid.NewGuid(), Registration = "LX-VCF", AircraftTypeId = aircraftTypes[21].Id, AirlineId = airlines[12].Id,
                    HasSpecialLivery = true, FirstSeen = new DateTime(2020, 06, 05), LastSeen = new DateTime(2021, 10, 28), Image = "images/93540_1598318875.jpg",
                    AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
                new Aircraft{ Id = Guid.NewGuid(), Registration = "JA872A", AircraftTypeId = aircraftTypes[23].Id, AirlineId = airlines[17].Id,
                    HasSpecialLivery = false, FirstSeen = new DateTime(2020, 06, 05), LastSeen = new DateTime(2020, 06, 15), Image = "images/IMG_2287.jpg",
                    AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
                new Aircraft{ Id = Guid.NewGuid(), Registration = "A6-EDD", AircraftTypeId = aircraftTypes[17].Id, AirlineId = airlines[16].Id,
                    HasSpecialLivery = false, FirstSeen = new DateTime(2020, 06, 05), LastSeen = new DateTime(2021, 08, 05), Image = "images/13047_1527973248.jpg",
                    AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
                new Aircraft{ Id = Guid.NewGuid(), Registration = "A6-EQA", AircraftTypeId = aircraftTypes[22].Id, AirlineId = airlines[16].Id,
                    HasSpecialLivery = false, FirstSeen = new DateTime(2020, 07, 13), LastSeen = new DateTime(2021, 08, 27), Image = "images/IMG_2065.jpg",
                    AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
                new Aircraft{ Id = Guid.NewGuid(), Registration = "OO-ABA", AircraftTypeId = aircraftTypes[13].Id, AirlineId = airlines[13].Id,
                    HasSpecialLivery = false, FirstSeen = new DateTime(2020, 07, 13), LastSeen = new DateTime(2021, 08, 27), Image = "images/12199_1554835793.jpg", 
                    AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
                new Aircraft{ Id = Guid.NewGuid(), Registration = "G-XWBA", AircraftTypeId = aircraftTypes[16].Id, AirlineId = airlines[8].Id,
                    HasSpecialLivery = false, FirstSeen = new DateTime(2020, 07, 13), LastSeen = new DateTime(2021, 08, 27), Image = "images/10569_1567245788.jpg",
                    AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
                new Aircraft{ Id = Guid.NewGuid(), Registration = "YL-CSJ", AircraftTypeId = aircraftTypes[4].Id, AirlineId = airlines[11].Id,
                    HasSpecialLivery = true, FirstSeen = new DateTime(2020, 07, 31), LastSeen = new DateTime(2021, 05, 05), Image = "images/27669_1580328749.jpg", 
                    AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
                new Aircraft{ Id = Guid.NewGuid(), Registration = "YL-CSK", AircraftTypeId = aircraftTypes[4].Id, AirlineId = airlines[11].Id,
                    HasSpecialLivery = true, FirstSeen = new DateTime(2020, 07, 31), LastSeen = new DateTime(2021, 05, 05), Image = "images/1309661.jpg",
                    AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
                new Aircraft{ Id = Guid.NewGuid(), Registration = "YL-CSL", AircraftTypeId = aircraftTypes[4].Id, AirlineId = airlines[11].Id,
                    HasSpecialLivery = true, FirstSeen = new DateTime(2020, 07, 31), LastSeen = new DateTime(2020, 07, 31), Image = "images/1195582.jpg",
                    AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
                new Aircraft{ Id = Guid.NewGuid(), Registration = "YL-CSN", AircraftTypeId = aircraftTypes[4].Id, AirlineId = airlines[11].Id,
                    HasSpecialLivery = false, FirstSeen = new DateTime(2020, 07, 31), LastSeen = new DateTime(2020, 07, 31), Image = "images/44344_1544504053.jpg",
                    AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
                new Aircraft{ Id = Guid.NewGuid(), Registration = "PH-EZT", AircraftTypeId = aircraftTypes[25].Id, AirlineId = airlines[5].Id,
                    HasSpecialLivery = false, FirstSeen = new DateTime(2021, 10, 28), LastSeen = new DateTime(2021, 10, 28), Image = "images/12946_1520765802.jpg",
                    AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
                new Aircraft{ Id = Guid.NewGuid(), Registration = "OO-SSL", AircraftTypeId = aircraftTypes[5].Id, AirlineId = airlines[0].Id,
                    HasSpecialLivery = false, FirstSeen = new DateTime(2021, 07, 08), LastSeen = new DateTime(2022, 02, 11),
                    Image = "images/OO-SSL_EBBR_11-02-22_4.jpg", AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
                new Aircraft{ Id = Guid.NewGuid(), Registration = "N12003", AircraftTypeId = aircraftTypes[24].Id, AirlineId = airlines[14].Id,
                    HasSpecialLivery = false, FirstSeen = new DateTime(2020, 07, 13), LastSeen = new DateTime(2022, 02, 11),
                    Image = "images/N12003_EBBR_11-02-22_6.jpg", AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
                new Aircraft{ Id = Guid.NewGuid(), Registration = "OO-TNB", AircraftTypeId = aircraftTypes[18].Id, AirlineId = airlines[1].Id,
                    HasSpecialLivery = false, FirstSeen = new DateTime(2020, 07, 29), LastSeen = new DateTime(2022, 02, 11),
                    Image = "images/OO-TNB-EBBR_11-02-22_4.jpg", AddedOn = DateTime.Now, ModifiedOn = DateTime.Now },
            };
            #endregion
            ...
            AircraftAtAirport[] aircraftsAtAirports = new AircraftAtAirport[]
            {
                ...
                new AircraftAtAirport{ AircraftId = aircrafts[3].Id, AirportId = airports[10].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[3].Id, AirportId = airports[4].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[3].Id, AirportId = airports[9].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[4].Id, AirportId = airports[2].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[4].Id, AirportId = airports[11].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[4].Id, AirportId = airports[0].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[5].Id, AirportId = airports[9].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[5].Id, AirportId = airports[7].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[5].Id, AirportId = airports[13].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[5].Id, AirportId = airports[10].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[6].Id, AirportId = airports[9].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[6].Id, AirportId = airports[0].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[6].Id, AirportId = airports[13].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[6].Id, AirportId = airports[6].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[7].Id, AirportId = airports[0].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[7].Id, AirportId = airports[14].Id},
                new AircraftAtAirport{ AircraftId = aircrafts[8].Id, AirportId = airports[14].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[8].Id, AirportId = airports[13].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[9].Id, AirportId = airports[8].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[9].Id, AirportId = airports[1].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[10].Id, AirportId = airports[8].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[10].Id, AirportId = airports[0].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[10].Id, AirportId = airports[1].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[11].Id, AirportId = airports[8].Id },
                new AircraftAtAirport{ AircraftId = aircrafts[12].Id, AirportId = airports[8].Id },
