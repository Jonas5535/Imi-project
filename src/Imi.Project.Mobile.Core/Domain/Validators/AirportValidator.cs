    ...
    public class AirportValidator : AbstractValidator<Airport>
    {
        public AirportValidator()
        {
            ...
            RuleFor(airport => airport.IATACode)
                ...
                .Length(3)
                .WithMessage("De IATA code van een luchthaven moet 3 karakters lang zijn");

            RuleFor(airport => airport.ICAOCode)
                .NotEmpty()
                .WithMessage($"De ICAO code mag niet leeg zijn")
                .Length(4)
                .WithMessage("De ICAO code van een luchthaven moet 4 karakters lang zijn");
            ...
            RuleFor(airport => airport.Country)
                ...
                .MinimumLength(4)
                .WithMessage($"Het land moet minstens 4 karakters lang zijn");
